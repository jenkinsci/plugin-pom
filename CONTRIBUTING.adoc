...
Running locally built versions of `../maven-hpi-plugin/src/main/java/org/jenkinsci/maven/plugins/hpi/enforcer/RequireNonObsoleteDependencyManagement.java` is more challenging.
...
mvnd clean verify -Dinvoker.test=bom-obsolete-override-*
----
